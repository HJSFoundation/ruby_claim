...
module RubyClaim
  c = RubyClaim::Claim.new(:hide_background => false)
      ...
      c.other_source_type                                     = "J1"
      c.other_source_identifier                               = "10000000000002"
      ...
      c.service_facility_legacy_identifier                    = "10000000000"
      ...
      c.billing_provider_legacy_identifier                    = "10000000000"
    ...
    (0...6).each do |i|
      c.build_service do |s|
        ...
        s.id_qualifier         = "J1"
        s.provider_id_number   = rand(10000000000000).to_s
